...
# 슬레이브에서 MySQL 복제 설정
mysql -u replica -h localhost -P 3306 -e "STOP SLAVE;"
mysql -u replica -h localhost -P 3306 -e "RESET SLAVE;"
...
mysql -u replica -h localhost -P 3306 -e "CHANGE MASTER TO MASTER_HOST='$MASTER_IP', MASTER_USER='replicator', MASTER_PASSWORD='1234', MASTER_AUTO_POSITION=1;"
mysql -u replica -h localhost -P 3306 -e "START SLAVE;"

# 복제 상태 확인
mysql -u replica -h localhost -P 3306 -e "SHOW SLAVE STATUS\G;"
